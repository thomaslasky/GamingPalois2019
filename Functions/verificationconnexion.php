<?php
	...
	if (isset($_SESSION['id'])) {
		...
		$loginBarre .= "<div class='space-between'><span onclick='requestFormUser(readDataFormUser,\"Login\")'>Connexion</span><span onclick='requestFormUser(readDataFormUser,\"Inscription\")'>Inscription</span></div>";
	}
